...
impl AccountsPage {
    ...
    fn render_account_row(
        ...
        div()
            ...
            .gap(px(12.0))
            .child(
                // Same identity mark as the sidebar, so one account reads the
                // same in both places. Seeded on the address, which is what
                // distinguishes two logins to the same provider.
